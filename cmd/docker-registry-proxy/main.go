...
func main() {
	...
	preFunc := func() error {
		var upstreamAuthService dockerregistryproxyv1.AuthenticationProviderClient
...
func parseAuthenticationVerifierClients() (map[string]dockerregistryproxyv1.AuthenticationVerifierClient, error) {
	res := map[string]dockerregistryproxyv1.AuthenticationVerifierClient{}
